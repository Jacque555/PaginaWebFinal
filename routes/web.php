...
use App\Http\Controllers\RebajasController;
...
Route::get('/Inicio', [PrincipalController::class, 'index'])->name('Principal');

Route::get('/rebajas', [RebajasController::class, 'index'])->name('Rebajas');

Route::post('/responder-pregunta', [ChatBotController::class, 'responderPregunta']);
